-- ============================================================================
-- Asignación de Residente de Obra: Alfredo Canales -> 9 NOGALES
--
-- Habilita el proyecto "9 NOGALES" en el selector de proyectos de las pantallas
...
WHERE p.project_description = '9 NOGALES' AND p.state = TRUE
  AND u.email = 'acanales@abril.pe'
...
-- WHERE p.project_description = '9 NOGALES';
