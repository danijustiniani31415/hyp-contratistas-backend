...
namespace Abril_Backend.Features.PedidosModule.Infrastructure.Models
{
    ...
    /// rol hardcodeado). Flujo: PENDIENTE → APROBADO/RECHAZADO (Gerencia) → ENTREGADO
    /// (Almacenero, descuenta stock vía lb_movimiento) — o CANCELADO por el propio solicitante.
    /// </summary>
    [Table("lb_pedido")]
    public class Pedido
    {
