...
namespace Abril_Backend.Features.CostsModule.Features.Configuration.CostosPresupuestosEmailFeature.Application.Interfaces
{
    public interface ICostosPresupuestosEmailService
    {
