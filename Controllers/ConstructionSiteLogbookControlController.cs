...
namespace Abril_Backend.Controllers
{
    ...
    public class ConstructionSiteLogbookControlController : ControllerBase
    {
        IConstructionSiteLogbookControlService _service;
        public ConstructionSiteLogbookControlController(IConstructionSiteLogbookControlService service)
        {
            _service = service;
        }
        ...
        public async Task<IActionResult> Create([FromForm] ConstructionSiteLogbookControlCreateDTO dto)
        {
            try
            {
